...
class JArrayInitializer extends JExpression {
    ...
    public void codegen(CLEmitter output) {
        ...
        for (int i = 0; i < initials.size(); i++) {
            ...
            }  else if (componentType == Type.LONG) { // project5/problem1 else if case for long for LASTORE
                output.addNoArgInstruction(LASTORE);
            }  else if (componentType == Type.DOUBLE) { // project5/problem1 else if case for double for DASTORE
