...
class JVariable extends JExpression implements JLhs {
    ...
    public void codegen(CLEmitter output) {
        if (iDefn instanceof LocalVariableDefn) {
            ...
            }  // project5/problem1 make else if case for type long to load long values from offset
            ...
            // project5/problem1 make else if case for type double to load double values from offset
    ...
    public void codegenStore(CLEmitter output) {
        if (iDefn instanceof LocalVariableDefn) {
            ...
            } else if (type == Type.LONG) { // project5/problem1 make else if case for type long to store long values
                switch (offset) {
                    case 0:
            ...
            } else if (type == Type.DOUBLE) { // project5/problem1 make else if case for type double to store double values
                switch (offset) {
                    case 0:
