...
class JArrayExpression extends JExpression implements JLhs {
    ...
    public void codegen(CLEmitter output) {
        ...
        } else if (type == Type.LONG) { // project5/problem1 else if case for long for LALOAD
            output.addNoArgInstruction(LALOAD);
        }  else if (type == Type.DOUBLE) { // project5/problem1 else if case for double for DALOAD
    ...
    public void codegenStore(CLEmitter output) {
        ...
        }  else if (type == Type.LONG) { // project5/problem1 else if case for long for LASTORE
            output.addNoArgInstruction(LASTORE);
        }  else if (type == Type.DOUBLE) { // project5/problem1 else if case for double for DASTORE
