...
class Conversions {
    ...
    public Conversions() {
        ...
        put(Type.LONG, Type.DOUBLE, new L2D()); // project5/problem1 adding the converter from long to double
        put(Type.LONG, Type.INT, new L2I()); // project5/problem1 adding the converter from long to int
        put(Type.LONG, Type.CHAR, new L2C()); // project5/problem1 adding the converter from long to char
        put(Type.DOUBLE, Type.INT, new D2I()); // project5/problem1 adding the converter from double to int
        put(Type.DOUBLE, Type.CHAR, new D2C()); // project5/problem1 adding the converter from double to char
        put(Type.DOUBLE, Type.LONG, new D2L()); // project5/problem1 adding the converter from double to long
        put(Type.INT, Type.DOUBLE, new I2D()); // project5/problem1 adding the converter from int to double
        put(Type.INT, Type.LONG, new I2L()); // project5/problem1 adding the converter from int to long
        put(Type.CHAR, Type.LONG, new I2L());  // project5/problem1 adding the converter from char to long
        put(Type.CHAR, Type.DOUBLE, new I2D()); // project5/problem1 adding the converter from char to double
        ...
        // project5/problem1 implementing boxing for type long
        put(Type.LONG, Type.BOXED_LONG, new Boxing(Type.LONG, Type.BOXED_LONG));
        // project5/problem1 implementing boxing for type Double
        ...
        put(Type.BOXED_BOOLEAN, Type.BOOLEAN, new UnBoxing(Type.BOXED_BOOLEAN, Type.BOOLEAN,
                "booleanValue"));
        // project5/problem1 implementing unboxing for type long
        put(Type.BOXED_LONG, Type.LONG, new UnBoxing(Type.BOXED_LONG, Type.LONG, "longValue"));
        // project5/problem1 implementing unboxing for type double
