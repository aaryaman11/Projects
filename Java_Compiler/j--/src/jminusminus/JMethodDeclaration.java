...
class JMethodDeclaration extends JAST implements JMember {
    ...
    public void partialCodegen(Context context, CLEmitter partial) {
        ...
        } else if (returnType == Type.LONG) { // project5/problem1 implemented else if case for long
            partial.addNoArgInstruction(LCONST_0);
            partial.addNoArgInstruction(LRETURN); // returning long
        } else if (returnType == Type.DOUBLE) { // project5/problem1 implemented else if case for double
            partial.addNoArgInstruction(DCONST_0);
            partial.addNoArgInstruction(DRETURN); // returning double
        } else {
