...
{if ("" != null) return statement;}
  ...
  final private JStatement statement() throws ParseException {int line = 0;
    ArrayList<JStatement> initial = null;
...
line = token.beginLine;
        ...
        // project4/problem9 implementing the RPAREN
                 body = statement();
statement = new JForStatement(line, initial ,expr, update , body);
        break;
        }
      case DO:{
        jj_consume_token(DO);
line = token.beginLine;
        ...
        // project4/problem8 implementing WHILE
                test = parExpression();
        jj_consume_token(SEMI);
statement = new JDoStatement(line, consequent, test);
        break;
        }
      case IF:{
        jj_consume_token(IF);
...
{if ("" != null) return expr;}
  ...
  final private ArrayList<JStatement> forInit() throws ParseException {int line = 0;
    JStatement statement  = null; // project4/problem9 initializing statement to null
    Type type = null; // project4/problem9 initializing type to null
    // project4/problem9 making new array list for variable declarator
    ArrayList<JVariableDeclarator> vdecls = new ArrayList<JVariableDeclarator>();
    // project4/problem9 making new array list for statement
    ArrayList<JStatement> state = new ArrayList<JStatement>();
    try {
      if (jj_2_6(2147483647)) {
        // project4/problem9 using LOOKAHEAD to check for statement expression
              statement = statementExpression();
state.add(statement);
        label_8:
        while (true) {
          ...
          jj_consume_token(COMMA);
          // project4/problem9 implementing the COMMA
                   statement = statementExpression();
state.add(statement);
        }
      } else {
...
state.add(new JVariableDeclaration(line, vdecls));
          break;
          }
        default:
          jj_la1[20] = jj_gen;
...
{if ("" != null) return state;}
  ...
  final private ArrayList<JStatement> forUpdate() throws ParseException {int line = 0;
      JStatement statement  = null;
      // project4/problem9 making new array list for statement
      ArrayList<JStatement> state = new ArrayList<JStatement>();
    try {
...
line = expr.line();
            if (expr instanceof JAssignment
             ...
             || expr instanceof JPostIncrementOp // project4/problem6 implementing JPostIncrementOp
             || expr instanceof JPreDecrementOp // project4/problem6 implementing JPreDecrementOp
...
lhs = new JAndAssignOp(line, lhs, rhs);
        ...
        case ARSHIFT_ASSIGN:{
          ...
          // project4/problem6 implementing the ARSHIFT_ASSIGN
                      rhs = assignmentExpression();
...
lhs = new JAssignOp(line, lhs, rhs);
        ...
        case DIV_ASSIGN:{
          ...
          // project4/problem6 implementing the DIVT_ASSIGN
                      rhs = assignmentExpression();
lhs = new JDivAssignOp(line, lhs, rhs);
        ...
        case LRSHIFT_ASSIGN:{
          ...
          // project4/problem6 implementing the LRSHIFT_ASSIGN
                      rhs = assignmentExpression();
lhs = new JLRightShiftAssignOp(line, lhs, rhs);
        ...
        case MINUS_ASSIGN:{
          ...
          // project4/problem6 implementing the MINUS_ASSIGN
                      rhs = assignmentExpression();
lhs = new JMinusAssignOp(line, lhs, rhs);
        ...
        case OR_ASSIGN:{
          ...
          // project4/problem6 implementing the OR_ASSIGN
                      rhs = assignmentExpression();
lhs = new JOrAssignOp(line, lhs, rhs);
        ...
        case PLUS_ASSIGN:{
          ...
          // project4/problem6 implementing the PLUS_ASSIGN
                      rhs = assignmentExpression();
lhs = new JPlusAssignOp(line, lhs, rhs);
        ...
        case REM_ASSIGN:{
          ...
          // project4/problem6 implementing the REM_ASSIGN
                      rhs = assignmentExpression();
lhs = new JRemAssignOp(line, lhs, rhs);
        ...
        case STAR_ASSIGN:{
          ...
          // project4/problem6 implementing the STAR_ASSIGN
                      rhs = assignmentExpression();
lhs = new JStarAssignOp(line, lhs, rhs);
        ...
        case XOR_ASSIGN:{
          ...
          // project4/problem6 implementing the XOR_ASSIGN
                      rhs = assignmentExpression();
...
{if ("" != null) return lhs;}
  ...
  final private JExpression conditionalExpression() throws ParseException {int line = 0;
    JExpression lhs = null, rhs = null;
    JExpression expr = null;  // project4/problem7 initializing the expr to null
...
line = lhs.line();
      ...
      case QUESTION:{
        ...
        // project4/problem7 implementing QUESTION for if else case(e? e1:e2)
                    expr = expression();
        jj_consume_token(COLON);
        // project4/problem7 implementing COLON for the else case in the if statement
...
line = lhs.line();
      ...
      while (true) {
        ...
        // project4/problem6 implementing the LOR
...
line = lhs.line();
      ...
      while (true) {
        ...
        jj_consume_token(OR);
        // project4/problem6 implementing OR
...
line = lhs.line();
      ...
      while (true) {
        ...
        // project4/problem6 implementing XOR
                    rhs = andExpression();
  ...
  private boolean jj_3R_34()
 {
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x0,0x40000000,0x41000,0x1000,0x1000,0x1000000,0x40b000,0x40a000,0x0,0x40a000,0x1a68e000,0x1a284000,0x240a000,0x2000000,0x2000000,0x2000000,0x1a284000,0x0,0x40a000,0x0,0x40a000,0x0,0x0,0x0,0x2000000,0x0,0x2000000,0x0,0x2000000,0x40a000,0x40a000,0x0,0x0,0x40a000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x2000000,0x0,0x2000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000000,0x40a000,0x0,0x0,0x0,0x2000000,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x20,0x0,0x5c0,0x5c0,0x5c0,0x0,0x405c5,0x40005,0x10800000,0x5,0x118a2a1d,0x118a2a18,0x102281d,0x1022818,0x1022818,0x1022818,0x118a2a18,0x100000,0x5,0x100000,0x5,0x100000,0x100000,0x0,0x1822818,0x100000,0x1822818,0x100000,0x1022818,0x5,0x5,0x400000,0x400000,0x5,0x40000000,0x40000000,0x0,0x0,0x0,0x0,0x0,0x80000000,0x0,0x0,0x0,0x0,0x20000000,0x20000000,0x0,0x0,0x0,0x0,0x1022818,0x0,0x1022818,0x600000,0x0,0x0,0x1000000,0x600000,0x1000000,0x1000000,0x1200000,0x1000000,0x1022818,0x5,0x800000,0x1000000,0x400000,0x20010,};
	}
	private static void jj_la1_init_2() {
	   jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2284820,0x2284820,0x2284820,0x2284820,0x2284820,0x2284820,0x2284820,0x0,0x0,0x0,0x0,0x0,0x0,0x8,0x2284820,0x0,0x2284820,0x0,0x2284820,0x0,0x0,0x0,0x0,0x0,0xa512008d,0xa512008d,0x8000000,0x8000,0x1000,0x800000,0x0,0x0,0x400100,0x400100,0x42600,0x42600,0x10002,0x10002,0x2080000,0x2080000,0x50000040,0x50000040,0x2284820,0x204000,0x0,0x0,0x820,0x820,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
	}
	private static void jj_la1_init_3() {
	   jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x4,0x4,0x0,0x4,0xe64,0xe64,0xe64,0xe64,0xe64,0xe64,0xe64,0x0,0x4,0x0,0x4,0x0,0x0,0x0,0xe64,0x0,0xe64,0x0,0xe64,0x0,0x0,0x0,0x0,0x4,0x2,0x2,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xe64,0x0,0xe64,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xe64,0x4,0x0,0x0,0x0,0xe60,};
	}
